...
public class FileBrowser
{
    ...
    public bool useServerList = false;
    ...
    public bool draw()
    {
        ...
        switch(layout) {
            ...
            default:
                ...
                if((selectStyle==null) ? GUILayout.Button("Select", GUILayout.Height(36)) : GUILayout.Button("Select", selectStyle, GUILayout.Height(36))) { return true; }
                if((cancelStyle==null) ? GUILayout.Button("Cancel", GUILayout.Height(36)) : GUILayout.Button("Cancel", cancelStyle, GUILayout.Height(36))) {
                    outputFile=null;
                    return true;
                }
                break;
